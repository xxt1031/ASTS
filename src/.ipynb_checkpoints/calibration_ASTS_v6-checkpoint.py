...
from src.calibrator.calibrator_ASTS_v6 import \
    TS, VS, ETS, CaGCN, GATS, IRM, SplineCalib, Dirichlet, OrderInvariantCalib, GAETS, ASTS
...
def main(dataset_index, split, init, eval_type_list, args):
    ...
    for fold in range(max_fold):
        ...
        if args.calibration == 'TS':
            ...
            temp_model = ASTS(model, data.edge_index, data.num_nodes, num_classes, 100)
