...
def main(dataset_index, split, init, eval_type_list, args):
    ...
    uncal_group_eces_temp = torch.zeros(10)
    group_eces_temp = torch.zeros(10)
...
if __name__ == '__main__':
    ...
    uncal_group_eces_total = torch.zeros(10)
    group_eces_total = torch.zeros(10)
    ...
    # Saving plots
    figure_filename = f'ece_nodelevel_homo_{args.model}_{args.calibration}_{args.dataset}_mean.png'
    figure_path = Path(os.path.join('figure', 'ece_results'))
