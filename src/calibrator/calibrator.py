...
from src.calibrator.ASTS_layer import ASTS_Layer
...
class ASTS(nn.Module):
    def __init__(self, model, edge_index, num_nodes, num_class, hidden_channels_ASTS):
        super().__init__()
        self.model = model
        self.num_nodes = num_nodes
        self.asts =  ASTS_Layer(in_channels=num_class,
                                 hidden_channels = hidden_channels_ASTS,
